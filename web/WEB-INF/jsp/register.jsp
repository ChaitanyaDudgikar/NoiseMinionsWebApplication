        ...
        <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100">
                    ...
                    <form:form commandName="registerform" class="login100-form validate-form">
                        ...
                        <div class="wrap-input100 validate-input" data-validate = "Special Password is required">
                            <form:input class="input100" type="password" path="specialpassword" placeholder="Special Password"/>
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
                                <i class="fa fa-lock" aria-hidden="true"></i>
                            </span>
